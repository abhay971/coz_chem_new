...
const Features = () => {
  ...
  const mainFeatures = [
    ...
    },
    {
      ...
      description:
        "Global supply chain network ensures rapid delivery to over 50 countries worldwide.",
      color: "brand-blue",
      stats: "Stipulated Leadtime",
      benefits: ["Express Shipping", "Emergency Supply", "Real-time Tracking"],
    },
    {
      icon: Leaf,
      title: "Sustainable Chemistry",
      description:
        "Committed to environmentally responsible practices and green chemistry principles.",
      color: "brand-green",
  ...
  const additionalFeatures = [
    {
      ...
      description:
        "Multiple awards for innovation and excellence in chemical manufacturing.",
    },
    {
      icon: Users,
      title: "Expert Team",
      description:
        "Over 200 skilled chemists and engineers with decades of combined experience.",
    },
    {
      icon: Globe,
      title: "Global Presence",
      description:
        "Serving clients across 50+ countries with local support and expertise.",
    },
    {
      icon: Zap,
      title: "Innovation Focus",
      description:
        "Continuous R&D investment to stay ahead of industry trends and needs.",
    },
  ];
          ...
          >
            {mainFeatures.map((feature, index) => (
              ...
              >
                {/* Background Gradient */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br from-${feature.color}/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                ></div>

                <div className="relative z-10 space-y-6">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 bg-${feature.color}/10 group-hover:bg-${feature.color}/20 rounded-2xl flex items-center justify-center transition-colors duration-300`}
                  >
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div
                        className={`text-sm font-semibold text-${feature.color} bg-${feature.color}/10 px-3 py-1 rounded-full inline-block`}
                      >
                        {feature.stats}
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      {feature.benefits.map((benefit, benefitIndex) => (
                        ...
                        >
                          <CheckCircle
                            className={`w-4 h-4 text-${feature.color} mr-2 flex-shrink-0`}
                          />
                          {benefit}
                        </div>
                      ))}
                  ...
                  <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div
                      className={`w-8 h-8 bg-${feature.color} rounded-full flex items-center justify-center`}
                    >
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Our clients experience measurable improvements in their
                    operations, from cost savings to enhanced product quality
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300">
                Numbers that speak to our commitment and success in the chemical
                industry.
              </p>
            </div>
